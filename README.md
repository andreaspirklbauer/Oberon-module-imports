...
2. Allow importing any number of modules in any order
3. Allow re-imports to co-exist with module alias names and globally declared identifiers
4. Allow reusing the original module name if a module has been imported under a module alias name
5. Handle type alias names among imported and re-imported modules correctly
6. Propagate imported export numbers of type descriptor addresses to client modules
